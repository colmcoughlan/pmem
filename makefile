...
all: read_driver FT_convolution update_Lagrangian CE_functions map_stats newton_raphson steepest_descent pmem link
...
newton_raphson: src/newton_raphson.cpp
	$(CC) $(CCFLAGS) src/newton_raphson.cpp
	
steepest_descent: src/steepest_descent.cpp
	$(CC) $(CCFLAGS) src/steepest_descent.cpp

pmem: src/pmem.cpp
	$(CC) $(CCFLAGS) src/pmem.cpp

link:
	$(LINK) -o pmem pmem.o read_driver.o FT_convolution.o update_Lagrangian.o CE_functions.o map_stats.o steepest_descent.o newton_raphson.o $(LINKOPTS)
	rm -rf *.o
